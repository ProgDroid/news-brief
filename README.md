...
Each evening it gathers source material — RSS/Substack feeds, X (Twitter) feeds via RSSHub,
the BCA *Iran Conflict Daily Dashboard*, and recent podcast commentary from a vector
...
After the prose brief, the model emits a JSON array following a `---SIGNALS---` marker. `collect`
